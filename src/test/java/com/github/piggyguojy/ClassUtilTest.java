...
public class ClassUtilTest {
  ...
  public void test6() {
    ...
    assertNull(
        ClassUtil.getTheOnlyOneAnnotation(ClassUtilTest.class, XmlRootElement.class, Slf4j.class));
    assertNotNull(ClassUtil.getTheOnlyOneAnnotation(Msg.class, Deprecated.class, GsonBean.class));
    assertEquals(ClassUtil.getTheOnlyOneAnnotation(Msg.class, Deprecated.class, GsonBean.class),
        GsonBean.class);
    assertNull(ClassUtil.getTheOnlyOneAnnotation(
        Msg.class,
        ImmutableSet.<Class<? extends Annotation>>builder().add(XmlRootElement.class)
            .add(Slf4j.class).build()));
    assertNull(ClassUtil.getTheOnlyOneAnnotation(
        Msg.class,
        ImmutableSet.<Class<? extends Annotation>>builder().add(XmlRootElement.class)
            .add(ExcelBean.class).build()));
    assertNull(ClassUtil.getTheOnlyOneAnnotation(
        Msg.class,
    ...
    assertNotNull(ClassUtil.getTheOnlyOneAnnotation(
        Msg.class,
        ImmutableSet.<Class<? extends Annotation>>builder().add(Deprecated.class)
            .add(GsonBean.class).build()));
    assertEquals(ClassUtil.getTheOnlyOneAnnotation(
        Msg.class,
        ImmutableSet.<Class<? extends Annotation>>builder().add(Deprecated.class)
            .add(GsonBean.class).build()), GsonBean.class);
  }
