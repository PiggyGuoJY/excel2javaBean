...
public class AssertTest {
  ...
  public void notNul11() {
    ...
    assertFalse(
        Assert.notNul(new File(AssertTest.class.getResource("/simple/nothingFile.txt").getFile())));
    assertTrue(Assert
        .notNul(new File(AssertTest.class.getResource("/simple/TestExcelFile.xlsx").getFile())));
