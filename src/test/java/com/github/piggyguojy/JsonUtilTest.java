...
public class JsonUtilTest {
  ...
  public void test() {
    ...
    studentMsg2 = JsonUtil.json2JavaBean(new TypeToken<Msg<Student>>() {
    }.getType(), json);
    log.info("json=>javaBean: " + studentMsg2.toString());
  ...
  public void test2() {
    ...
    Msg<Student> studentMsg2 = (Msg<Student>) JsonUtil
        .json2JavaBean(Msg.class, json, GsonBuilderStrategy.NULLS_TO_NULL);
    log.info("json=>javaBean: " + studentMsg2.toString());
    assertNotEquals(studentMsg, studentMsg2);

    studentMsg2 = JsonUtil.json2JavaBean(new TypeToken<Msg<Student>>() {
    }.getType(), json, GsonBuilderStrategy.NULLS_TO_NULL);
    log.info("json=>javaBean: " + studentMsg2.toString());
    assertEquals(studentMsg, studentMsg2);
    ...
    studentMsg2 = (Msg<Student>) JsonUtil
        .json2JavaBean(Msg.class, json, GsonBuilderStrategy.NULLS_STRING_TO_EMPTY);
    log.info("json=>javaBean: " + studentMsg2.toString());
    assertNotEquals(studentMsg, studentMsg2);

    studentMsg2 = JsonUtil.json2JavaBean(new TypeToken<Msg<Student>>() {
    }.getType(), json, GsonBuilderStrategy.NULLS_STRING_TO_EMPTY);
    log.info("json=>javaBean: " + studentMsg2.toString());
    ...
    studentMsg2 = (Msg<Student>) JsonUtil
        .json2JavaBean(Msg.class, json, GsonBuilderStrategy.REMOVE_NULLS);
    log.info("json=>javaBean: " + studentMsg2.toString());
    assertNotEquals(studentMsg, studentMsg2);

    studentMsg2 = JsonUtil.json2JavaBean(new TypeToken<Msg<Student>>() {
    }.getType(), json, GsonBuilderStrategy.REMOVE_NULLS);
    log.info("json=>javaBean: " + studentMsg2.toString());
    assertEquals(studentMsg, studentMsg2);
  }
}