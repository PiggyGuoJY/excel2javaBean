...
public final class Assert {
   ...
   * @return byte数组是否为空
   */
  public static boolean isNul(byte[] bytes) {
   ...
   * @return byte数组是否非空
   */
  public static boolean notNul(byte[] bytes) {
    return notNull(bytes) && bytes.length != 0;
  }
   ...
   * @return short数组是否为空
   */
  public static boolean isNul(short[] shorts) {
    return isNull(shorts) || shorts.length == 0;
  }
   ...
   * @return short数组是否非空
   */
  public static boolean notNul(short[] shorts) {
    return notNull(shorts) && shorts.length != 0;
  }
   ...
   * @return int数组是否为空
   */
  public static boolean isNul(int[] ints) {
    return isNull(ints) || ints.length == 0;
  }
   ...
   * @return int数组是否非空
   */
  public static boolean notNul(int[] ints) {
    return notNull(ints) && ints.length != 0;
  }
   ...
   * @return long数组是否为空
   */
  public static boolean isNul(long[] longs) {
    return isNull(longs) || longs.length == 0;
  }
   ...
   * @return long数组是否非空
   */
  public static boolean notNul(long[] longs) {
    return notNull(longs) && longs.length != 0;
  }
   ...
   * @return float数组是否为空
   */
  public static boolean isNul(float[] floats) {
    return isNull(floats) || floats.length == 0;
  }
   ...
   * @return float数组是否非空
   */
  public static boolean notNul(float[] floats) {
    return notNull(floats) && floats.length != 0;
  }
   ...
   * @return double数组是否为空
   */
  public static boolean isNul(double[] doubles) {
    return isNull(doubles) || doubles.length == 0;
  }
   ...
   * @return double数组是否非空
   */
  public static boolean notNul(double[] doubles) {
    return notNull(doubles) && doubles.length != 0;
  }
   ...
   * @return char数组是否为空
   */
  public static boolean isNul(char[] chars) {
   ...
   * @return char数组是否非空
   */
  public static boolean notNul(char[] chars) {
    return notNull(chars) && chars.length != 0;
  }
   ...
   */
  public static boolean isNul(boolean[] booleans) {
    return isNull(booleans) || booleans.length == 0;
  }
   ...
   */
  public static boolean notNul(boolean[] booleans) {
    return notNull(booleans) && booleans.length != 0;
  }
   ...
   */
  public static boolean isNul(Object[] objects) {
   ...
   * @return 字符串是否为空
   */
  public static boolean isNul(String string) {
