  ...
  public enum GsonBuilderStrategy {
    ...
    REMOVE_NULLS(new GsonBuilder()
        ...
        .addSerializationExclusionStrategy(
            new GsonBuilderStrategy.GsonDefaultSerializationExclusionStrategy())
        .addDeserializationExclusionStrategy(
            new GsonBuilderStrategy.GsonDefaultDeserializationExclusionStrategy())
        //禁用Html编码转义
        .disableHtmlEscaping()),
    /**
    ...
    NULLS_TO_NULL(new GsonBuilder()
        ...
        .serializeNulls()),
    /**
     * null(String)对象在序列化时被置"", null和""反序列化时被置""; 其他类型null对象属性的序列化和反序列化策略同{@link
     * GsonBuilderStrategy#REMOVE_NULLS}
     */
