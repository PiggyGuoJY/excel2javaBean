...
public final class Msg<T> implements Serializable {
  ...
  public static <T> Msg<T> msg(String code, String msg, String detail, T t) {
    return new Msg<>(code, msg, detail, t);
  }
  ...
  public static <T> Msg<T> msg(T t, String msg) {
    return new Msg<>(t, msg);
  }

  public static <T> Msg<T> msg(Exception e) {
    return new Msg<>(e);
  }
